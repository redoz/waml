...
pub enum DiagCode {
    ...
    LayoutConflict,
    InvalidUseCaseGroup,
    ActorInsideSystemBoundary,
    UseCaseOutsideSystemBoundary,
    UseCaseInMultipleSystemBoundaries,
    EmptyUseCaseBand,
    MalformedMessage,
    MalformedLifeline,
...
impl DiagCode {
    pub fn as_str(self) -> &'static str {
        match self {
            ...
            DiagCode::InvalidUseCaseGroup => "invalid-use-case-group",
            DiagCode::ActorInsideSystemBoundary => "actor-inside-system-boundary",
            DiagCode::UseCaseOutsideSystemBoundary => "use-case-outside-system-boundary",
            DiagCode::UseCaseInMultipleSystemBoundaries => "use-case-in-multiple-system-boundaries",
            DiagCode::EmptyUseCaseBand => "empty-use-case-band",
