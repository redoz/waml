...
- preparation calls markdown `parse, reparse, promote, or reuse revisioned Markdown syntax`
- markdown returns `Markdown syntax snapshots` to preparation
- preparation calls okf `assemble the document catalog and lower the Markdown structure`
- okf returns `document catalog and OKF analysis` to preparation
